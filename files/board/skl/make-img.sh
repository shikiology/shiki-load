...
# Format partitions
sudo mkdosfs -F32 -n SHIKI1 "/dev/loop8p1"    >/dev/null 2>&1
sudo mkfs.ext2 -F -F -L SHIKI2 "/dev/loop8p2" >/dev/null 2>&1
sudo mkfs.ext4 -F -F -L SHIKI3 "/dev/loop8p3" >/dev/null 2>&1
