...
SHIKI_VERSION="0.0.1-official-legacy"
...
SHIKI_BZIMAGE_FILE="${CACHE_PATH}/bzImage-shiki"
SHIKI_RAMDISK_FILE="${CACHE_PATH}/initrd-shiki"
...
MODEL_CONFIG_PATH="/opt/shiki/model-configs"
INCLUDE_PATH="/opt/shiki/include"
PATCH_PATH="/opt/shiki/patch"
